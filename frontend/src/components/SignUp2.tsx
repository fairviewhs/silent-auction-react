    ...
    return (
      <div className="signUp">
        <div className="signUpInfo">
          <h2>Our Cause</h2>
          <p>
            This year, the Fairview National Honor Society is hosting a silent auction on February 28th and March 1st to support There With Care, a Boulder-based non-profit which provides resources and care for families of children with a critical illness. 
          </p>
